...
| 10–15 | Isolir+MikroTik, GL, Helpdesk pelanggan, FTTH port, HRD, kanal pelanggan | rancangan di `DESIGN-PHASE-8-BILLING-AND-BEYOND.md`; Fase 10 butuh keputusan §11.4 (ambang isolir) |
