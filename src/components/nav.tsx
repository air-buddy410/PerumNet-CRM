...
const iconByRoute: Record<string, LucideIcon> = {
  ...
  "/crm/customers/import": FileSpreadsheet,
  ...
  "/inventory/items/import": FileSpreadsheet,
  "/inventory/suppliers": Handshake,
  ...
  "/it/assets": Tag,
  "/it/identity-groups": UsersRound,
  "/it/mailserver/accounts": UserRoundCog,
