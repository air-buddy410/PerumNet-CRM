...
import { Activity, BookOpenCheck, Boxes, ChevronDown, ClipboardCheck, Contact, FolderKanban, LayoutDashboard, LifeBuoy, Megaphone, RadioTower, Receipt, Server, Settings, UsersRound, Wallet, Wrench } from "lucide-react";
